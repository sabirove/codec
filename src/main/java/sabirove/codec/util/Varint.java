...
/*
 * adapted from: com.clearspring.analytics:stream:2.9.5 ~ com.clearspring.analytics.util.Varint
...
public final class Varint {
     ...
     * @throws UncheckedIOException     wrapping the {@link IOException} if {@link OutputStream} throws {@link IOException}
     * @throws UncheckedIOException     wrapping the {@link EOFException} if the end of stream is reached while reading
    ...
    /**
     * Write unsigned {@code long} using the "zig-zag" LEB128 variable-length encoding.
